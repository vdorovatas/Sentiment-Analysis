...
class MultiHeadAttentionModel(nn.Module):
    ...
    def __init__(self, output_size, embeddings, max_length=60, n_head=5):
        ...
        self.ma = MultiHeadAttention(num_heads=n_head, head_size=head_size, n_embd=dim)
        self.ffwd = FeedFoward(dim)
        self.ln1 = nn.LayerNorm(dim)
        self.ln2 = nn.LayerNorm(dim)
...
class TransformerEncoderModel(nn.Module):
    def __init__(self, output_size, embeddings, max_length=60, n_head=2, n_layer=3):
        super().__init__()
        ...
        self.output = nn.Linear(n_head * head_size, output_size)
